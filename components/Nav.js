...
import { LogOut } from "../node_modules/lucide-react/dist/cjs/lucide-react";
...
export default function Nav({ show }) {
  ...
  const activeLink = "flex gap-1 p-1 bg-blue-300 text-black rounded-sm";
  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          href={"/politics"}
          className={pathname.includes("/politics") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            ...
            className={
              pathname.includes("/politics") ? activeIcon : inactiveIcon
            }
          >
